...
const category = {
  ...
  description:
    "Advanced audio-visual and collaboration systems for modern meeting spaces. Complete setups including projectors, video conferencing, and smart room automation.",
  categoryFilter: "Conference room solutions",
};
...
export default function ConferenceRoomSolutionsPage() {
