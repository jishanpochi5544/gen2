...
const categoryData = {
  title: "Remote Surveillance and Monitoring Solutions",
  description:
    "Enable real-time remote surveillance and monitoring for your facilities, assets, and operations from anywhere, anytime.",
  categoryFilter: "Remote Surveillance and Monitoring Solutions"
};
...
export default function CommandControlRoomRemotePage() {
