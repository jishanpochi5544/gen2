...
import { ArrowLeft, ArrowRight, Bell, CheckCircle, Building2, Settings, Users2, HelpCircle } from "lucide-react";
...
export const metadata: Metadata = {
  title: 'Intruder Detection System | GenX Security',
  description: 'Advanced intruder detection solutions including perimeter security, intrusion alarms, smart sensors, and ANIDERS for comprehensive protection.',
};

interface IntruderDetectionSystemPageProps {
  searchParams: { query?: string; category?: string };
}

export default function IntruderDetectionSystemPage({ searchParams }: IntruderDetectionSystemPageProps) {
