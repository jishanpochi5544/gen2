...
const category = {
  ...
  categoryFilter: "Voice Logger"
};

export const metadata: Metadata = {
  title: `${category.title} | Surveillance Systems | GenX Security`,
    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10">
        ...
        <div className="relative w-full h-[300px] md:h-[400px] overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-b from-yellow-600/20 to-yellow-400/10" />
          <div className="relative h-full container mx-auto px-4 md:px-6 flex flex-col justify-center items-center text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-yellow-600 tracking-tight mb-4">
              {category.title}
            </h1>
        ...
        <div className="container mx-auto px-4 md:px-6 py-12">
          <Button variant="outline" asChild className="mb-8 group hover:bg-primary/10 hover:border-primary">
            <Link href="/solutions/surveillance-systems">
              <ArrowLeft className="mr-2 h-4 w-4 group-hover:text-primary transition-colors" />
              <span className="group-hover:text-primary transition-colors">Back to Surveillance Systems</span>
            </Link>
          </Button>
          ...
          {categoryProducts.length > 0 ? (
            ...
            <div className="text-center py-12 bg-card rounded-lg shadow border">
              ...
              <Button variant="link" asChild className="text-primary">
                <Link href="/solutions/surveillance-systems">Back to Surveillance Systems</Link>
              </Button>
            </div>
          )}
          ...
          <div className="mt-16 text-center">
            <div className="bg-yellow-50 rounded-2xl p-8 border border-yellow-100">
              ...
              <Button size="lg" asChild className="bg-yellow-600 hover:bg-yellow-700 text-white">
                <Link href="/contact">
