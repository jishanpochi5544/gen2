...
const category = {
  title: "PA System",
  description:
    "Professional public address and communication systems for clear audio distribution. From small office setups to large venue installations with advanced control features.",
  categoryFilter: "PA system",
};
