...
const categoryData = {
  title: "Centralized Control Room Setup",
  description:
    "Integrate all your security and monitoring systems into a single, centralized control room for enhanced situational awareness and rapid response.",
  categoryFilter: "Centralized Control Room Setup"
};
...
export default function CommandControlRoomCentralizedPage() {
