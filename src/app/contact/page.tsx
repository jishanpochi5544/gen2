...
export default function ContactPage() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 z-0 w-full h-full bg-no-repeat bg-cover bg-center pointer-events-none"
        style={{ backgroundImage: 'url(/Solutions/sol_page/back0.jpg)' }}
      />
      {/* Foreground content */}
      <div className="relative z-10 py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-6">
          <header className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-primary">Contact Gen-X Secure</h1>
